...
class FullyConnectedNet(object):
    ...
    def __init__(
        ...
        for i in range(self.num_layers):
          ...
          # 添加batchnorm参数初始化，最后一层不添加，因为输出层affine不需要归一化
    ...
    def loss(self, X, y=None):
        ...
        for i in range(1, self.num_layers):
          ...
          # layer_input = relu_out  # set next structure input
        ...
        # compute softmax layer loss & grad
        ...
        # cal loss & L2 reg 为每层权重添加L2正则项，影响loss跟grad计算，防止过拟合
