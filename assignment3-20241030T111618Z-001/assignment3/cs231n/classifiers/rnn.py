...
class CaptioningRNN:
    ...
    def sample(self, features, max_length=30):
        ...
        # 初始化隐藏状态 h：通过仿射变换将输入的图像特征转换为初始隐藏状态
        h, _ = affine_forward(features, W_proj, b_proj)

        # 初始化第一个单词：将第一个单词设为 <START> token，并初始化 LSTM 的初始细胞状态 c 为零
        ...
        for i in range(max_length):
          ...
          # cal scores for all word
          scores, _ = affine_forward(h, W_vocab, b_vocab)

          # choose max score of the word and set it be the word in T
