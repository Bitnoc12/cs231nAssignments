...
def ls_discriminator_loss(scores_real, scores_fake):
    ...
    # 真实数据 scores_real，希望判别器的输出接近 1。因此，将 scores_real 与 1 之差的平方作为损失，然后取其均值，并乘以 0.5
    # 对于生成数据 scores_fake，希望判别器的输出接近 0。因此，直接将 scores_fake 的平方作为损失，然后取其均值，并乘以 0.5
...
def ls_generator_loss(scores_fake):
    ...
    # scores_fake 与 1 之差的平方作为损失，然后取其均值，并乘以 0.5
